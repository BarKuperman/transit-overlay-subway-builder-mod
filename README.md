...
### Loading the Mod
Every time you launch the game, you must initialize the mod manually to ensure the data loads correctly:
* Press **`Ctrl + Shift + R`** on your keyboard while on the main menu **before** entering any map.
...
* **Exiting Maps**: It is recommended to **close and re-open the game** every time you exit a map to ensure mod stability.
* **Initialization**: If you forget to press `Ctrl + Shift + R` before loading a map, the overlay menu and data will not appear.
